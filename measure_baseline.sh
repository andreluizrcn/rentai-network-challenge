...
docker exec teleconsulta ping -c 100 telemetria | tee ping_consulta_telemetria.txt
echo ""

# 2. Ping teleconsulta -> video
echo "[2/6] Ping: teleconsulta -> video (100 pacotes)"
docker exec teleconsulta ping -c 100 video_cirurgico | tee ping_consulta_video.txt
echo ""

# 3. Ping telemetria -> video
echo "[3/6] Ping: telemetria -> video (100 pacotes)"
docker exec telemetria ping -c 100 video_cirurgico | tee ping_telemetria_video.txt
echo ""
...
sleep 2
docker exec teleconsulta iperf3 -c telemetria -u -b 5M -t 10
...
sleep 2
docker exec teleconsulta iperf3 -c teleconsulta -u -b 2M -t 10
...
sleep 2
docker exec teleconsulta iperf3 -c video_cirurgico -t 10
...
echo " - ping_consulta_telemetria.txt"
echo " - ping_consulta_video.txt"
echo " - ping_telemetria_video.txt"
echo "=========================================="
